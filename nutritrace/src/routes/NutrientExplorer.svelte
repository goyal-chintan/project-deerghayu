...
<div class="page-shell analytics-shell" in:fade={{ duration: 160 }}>
  <header class="page-header analytics-header">
    <div class="ph-left header-copy">
      ...
      <div>
        ...
        <p class="page-subtitle">Use today’s diary, family targets, and food suggestions to decide what to plan next.</p>
      </div>
    </div>
    <div class="ph-right">
